...
<template>
  ...
  >
    <div class="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
      <h2 class="mb-1 text-center text-lg font-bold text-slate-800">輸入比分</h2><p class="mb-4 text-center text-sm text-slate-600">凍結賽制：{{ displayScoringFormat(live.scoringFormat) }}</p>
